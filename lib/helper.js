...
/**
 * waitForPopupClose Wait for the most recent popup to close
 *
...
Helper.prototype.waitForModalToClose = function(modal) {
  var self = this;
  browser.wait(function() {
    return modal.isPresent().then(function(res) {
      return !res;
    });
  }, self.MAX_TIMEOUT, 'should wait for modal to close');
};
