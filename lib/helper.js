...
// global timeout
var TIMEOUT = browser.params.config.maxTimeout;
...
Helper.prototype.waitForAngular = function() {
  ...
  }, TIMEOUT, 'should wait for angular');
};
...
Helper.prototype.waitForElementToShow = function(el) {
  ...
  }, TIMEOUT, 'should wait for element to show');
};
...
Helper.prototype.waitForAttribute = function(el, attr, fn) {
  ...
  }, TIMEOUT, 'should wait for attribute: ' + attr);
};
...
Helper.prototype.waitForUrl = function(url) {
  ...
  }, TIMEOUT, 'should wait for url: ' + url);
};
...
Helper.prototype.waitForScript = function(fn) {
  ...
  return browser.wait(function() {
    return self.run(fn);
  }, TIMEOUT, 'should wait for script to return true');
};
...
Helper.prototype.waitForModalTransition = function() {
  ...
  }, TIMEOUT, 'should wait for modal to transition');
};
