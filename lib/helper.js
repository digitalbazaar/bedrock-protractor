...
// expose mocha to helper
var Mocha = require('mocha');
var runMocha = Mocha.prototype.run;
Mocha.prototype.run = function() {
  api.mocha = this;
  api.suite = null;

  // update runner to integrate browser-mocha results
  var runner = api.runner = runMocha.apply(this, arguments);
...
Helper.prototype.runMocha = function(fn, options) {
